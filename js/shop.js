...
// let arrayProducts = allProducts.product;
...
//       productsCards += `
//         <div class="shop-card" id="shop-element${product.id}">
...
//             <a href="../pages/shop-detail.html?id=${product.id}" class="shopE-button-detail">Ver más</a>
